...
function getPageHref({
  ...
  return search
    ? `/estudiante/electrocardiograma?${search}`
    : "/estudiante/electrocardiograma";
}

export default async function ElectrocardiogramaPage({
  searchParams,
}: ElectrocardiogramaPageProps) {
  ...
  const historiasPage = await listHistoriasForElectrocardiograma({
    cursor,
    query,
  });
    ...
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-1">
        ...
        <p className="max-w-2xl text-sm text-muted-foreground">
          Selecciona una historia con electrocardiograma solicitado y registra
          su lectura cardiaca.
        </p>
      </div>
              ...
              {historiasPage.rows.length > 0 ? (
                      ...
                      <TableCell>
                        <div className="flex justify-end gap-2">
                          <Button asChild size="sm" variant="outline">
                            <Link
                              href={`/estudiante/electrocardiograma/${encodeURIComponent(
                                row.historiaId,
                              )}`}
                            >
                ...
                <TableRow>
                  <TableCell
                    ...
                    colSpan={6}
                  >
                    No hay historias con electrocardiograma solicitado
                    pendientes de registro que coincidan con la busqueda.
                  </TableCell>
                </TableRow>
              )}
            </TableBody>

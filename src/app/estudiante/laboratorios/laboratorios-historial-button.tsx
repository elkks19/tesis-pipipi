...
import { getLaboratoriosHistorial } from "./historial-actions";

type SummaryData = Awaited<ReturnType<typeof getLaboratoriosHistorial>>;

export function LaboratoriosHistorialButton({ historiaId }: { historiaId: string }) {
  ...
  async function openHistorial() {
    ...
    setLoading(true);
    try {
      const summary = await getLaboratoriosHistorial(historiaId);
      setData(summary);
      setOpen(true);
    } catch (error) {

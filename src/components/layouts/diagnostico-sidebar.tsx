...
const navItems = [
  {
    href: "/estudiante/diagnostico",
    icon: ClipboardListIcon,
    label: "Crear diagnostico",
  },
  {
    href: "/estudiante/diagnostico/actividad",
    icon: ActivityIcon,
    label: "Actividad",
  },
];
...
function isNavItemActive(pathname: string, href: string) {
  if (href === "/estudiante/diagnostico") {
    return (
      pathname === href ||
      (pathname.startsWith(`${href}/`) &&
        pathname !== "/estudiante/diagnostico/actividad")
    );
  }
...
export function DiagnosticoSidebar() {

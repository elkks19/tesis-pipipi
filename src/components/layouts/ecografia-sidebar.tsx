...
const navItems = [
  {
    href: "/estudiante/ecografia",
    icon: ClipboardListIcon,
    label: "Crear ecografia",
  },
  {
    href: "/estudiante/ecografia/actividad",
    icon: ActivityIcon,
    label: "Actividad",
  },
];
...
function isNavItemActive(pathname: string, href: string) {
  if (href === "/estudiante/ecografia") {
    return (
      pathname === href ||
      (pathname.startsWith(`${href}/`) &&
        pathname !== "/estudiante/ecografia/actividad")
    );
  }
...
export function EcografiaSidebar() {
  ...
  return (
    <Sidebar collapsible="icon" variant="floating">
      <SidebarHeader>
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton size="lg" tooltip="Ecografia">
              <div className="flex min-w-0 flex-col">
                <span className="truncate font-semibold">Ecografia</span>

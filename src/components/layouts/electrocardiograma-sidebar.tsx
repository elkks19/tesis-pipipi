...
const navItems = [
  {
    href: "/estudiante/electrocardiograma",
    icon: ClipboardListIcon,
    label: "Crear electro",
  },
  {
    href: "/estudiante/electrocardiograma/actividad",
    icon: ActivityIcon,
    label: "Actividad",
  },
];
...
function isNavItemActive(pathname: string, href: string) {
  if (href === "/estudiante/electrocardiograma") {
    return (
      pathname === href ||
      (pathname.startsWith(`${href}/`) &&
        pathname !== "/estudiante/electrocardiograma/actividad")
    );
  }
...
export function ElectrocardiogramaSidebar() {
  ...
  return (
    <Sidebar collapsible="icon" variant="floating">
      <SidebarHeader>
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton size="lg" tooltip="Electrocardiograma">

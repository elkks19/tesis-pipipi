...
const navItems = [
  {
    href: "/estudiante/espirometria",
    icon: ClipboardListIcon,
    label: "Crear espirometria",
  },
  {
    href: "/estudiante/espirometria/actividad",
    icon: ActivityIcon,
    label: "Actividad",
  },
];
...
function isNavItemActive(pathname: string, href: string) {
  if (href === "/estudiante/espirometria") {
    return (
      pathname === href ||
      (pathname.startsWith(`${href}/`) &&
        pathname !== "/estudiante/espirometria/actividad")
    );
  }
...
export function EspirometriaSidebar() {
  ...
  return (
    <Sidebar collapsible="icon" variant="floating">
      <SidebarHeader>
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton size="lg" tooltip="Espirometria">
              ...
              <div className="flex min-w-0 flex-col">
                <span className="truncate font-semibold">Espirometria</span>

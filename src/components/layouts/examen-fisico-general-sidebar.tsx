...
const navItems = [
  {
    href: "/estudiante/examen-fisico-general",
    icon: ClipboardListIcon,
    label: "Crear examen",
  },
  {
    href: "/estudiante/examen-fisico-general/actividad",
    icon: ActivityIcon,
    label: "Actividad",
  },
];
...
function isNavItemActive(pathname: string, href: string) {
  if (href === "/estudiante/examen-fisico-general") {
    return (
      pathname === href ||
      (pathname.startsWith(`${href}/`) &&
        pathname !== "/estudiante/examen-fisico-general/actividad")
    );
  }
...
export function ExamenFisicoGeneralSidebar() {
  ...
  return (
    <Sidebar collapsible="icon" variant="floating">
      <SidebarHeader>
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton size="lg" tooltip="Examen fisico">
